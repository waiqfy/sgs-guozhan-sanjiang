...
const translates = {
	...
	huan_fazheng: "幻法正",
	huan_fazheng_prefix: "幻",
	twanshu: "暗疏",
	twanshu_info: "出牌阶段限一次，你可弃置一名角色至多两个区域内的各一张牌，然后将这些牌交给另一名角色，该角色使用其中的：①非伤害牌结算后摸一张牌；②伤害类牌无次数限制。",
	twtongce: "通策",
	twtongce_info: `游戏开始时，你获得技能${get.poptip("twyishi")}，然后你可令一名其他角色交给你一张牌并获得${get.poptip("twyishi")}。`,
	twyishi: "弈势",
	twyishi_info: "转换技，每回合限一次，当你的体力值变化后，阳：你可弃置X张牌并回复1点体力；阴：你可对自己造成1点伤害并摸X+1张牌（X为你已损失体力值）。",
	huan_xiaoqiao: "幻小乔",
	huan_xiaoqiao_prefix: "幻",
	twshuyin: "姝音",
	twshuyin_info: "你每回合首次使用一种花色的牌后，可选择一项：1.你下次使用的♥️牌（装备牌与延时锦囊牌除外）额外结算一次；2.令一名角色将一张牌作为“芳妍”牌置于你的武将牌上，否则失去1点体力。",
	twfangyan: "芳妍",
	twfangyan_info: "锁定技，准备阶段或当你的体力值减少后，你获得武将牌上所有“芳妍”牌并摸等量张牌。除“芳妍”牌包含的花色外，你所有其他牌的花色均视为♥️。",
	...
	twsbzhenliang: "贞良",
	twsbzhenliang_info: "转换技。阳：出牌阶段限一次，你可以弃置X张与“任”颜色相同的牌并对攻击范围内的一名角色造成1点伤害（X为你与其体力值之差且X至少为1）。阴：你的回合外，一名角色使用或打出牌结算完成后，若此牌与“任”类别相同，则你可以令至多两名角色各摸两张牌。",
	huan_sunce: "幻孙策",
	huan_sunce_prefix: "幻",
	twliwu: "励伍",
	...
	twsbqingjian: "清俭",
	twsbqingjian_info: "锁定技。①当有一张牌不因使用而进入弃牌堆后，若你的“清俭”数小于X，你将此牌置于你的武将牌上，称为“清俭”（X为你的体力值+1，且至少为1）。②出牌阶段结束时，你将所有“清俭”分配给任意角色。",
	...
	tw_yujin_prefix: "SP",
	xinzhenjun: "镇军",
	xinzhenjun_info: "出牌阶段开始时，你可以将一张牌交给一名其他角色，令其选择是否使用一张不为黑色的【杀】。若其选择是，则你于此【杀】结算完成后摸X+1张牌（X为此【杀】造成的伤害总点数）。若其选择否，则你可以对其或其攻击范围内的一名其他角色造成1点伤害。",
	tw_hucheer: "TW胡车儿",
	...
	tw_puyangxing: "濮阳兴",
	twzhengjian: "征建",
	twzhengjian_info: "游戏开始时，你选择获得一项效果：⒈其他角色的出牌阶段结束时，若其本阶段内未使用过非基本牌，则其须交给你一张牌，然后你可失去此效果并获得〖征建〗的效果二。⒉其他角色的出牌阶段结束时，若其本阶段内未得到过牌，则其须交给你一张牌，然后你可失去此效果并获得〖征建〗的效果一。",
	twzhongchi: "众斥",
	...
	twhanhong: "翰鸿",
	twhanhong_backup: "翰鸿",
	twhanhong_info: "出牌阶段每种花色限一次，你可指定一种花色并弃置X张牌（X为你手牌中花色最多的牌数），然后观看牌堆顶前等量张你指定花色的牌并获得其中一张。若你以此法弃置的牌中有梅花牌，你摸一张牌。",
	twhuazhang: "华章",
	...
	twmiehai: "灭害",
	twmiehai_info: "每回合限三次，你可以将两张牌当作无距离次数限制的刺【杀】使用。此【杀】结算完成后，此过程中正面失去♠牌的角色各回复1点体力，你可以令其中任意名角色摸两张牌。",
	...
	twmitu: "密图",
	twmitu_info: "准备阶段，你可以令至多三名角色各摸两张牌并展示之，然后令这些角色依次选择是否与你指定的另一名角色拼点，拼点赢的角色视为对没赢的角色使用一张【杀】。每有一名角色未用以此法展示的牌进行拼点，你减少1点体力上限。",
	twqianliu: "潜流",
