...
const translates = {
	...
	reqizhi: "奇制",
	reqizhi_info: "蓄力技（1/2），出牌阶段每名角色限一次，你可以消耗1点蓄力点令一名角色摸两张牌，然后本阶段你使用基本牌或普通锦囊牌指定目标后，你依次观看本阶段因此摸牌的角色的手牌并弃置其一张牌。",
	rejinqu: "进趋",
	rejinqu_info: "锁定技，你每于回合内使用两张基本牌或普通锦囊牌后，你令一名拥有蓄力技的角色获得1点蓄力点；结束阶段，你摸X张牌（X为本回合你蓄力点点数存在过的最高值）。",
	zhuji: "朱绩",
	potjiezhu: "竭逐",
	...
	xinjilve: "极略",
	xinjilve_info: `①当你获得此技能时，你获得${get.poptip("guicai")}并根据你的势力获得以下对应技能：魏：${get.poptip("fangzhu")}；蜀：${get.poptip("jizhi")}；吴：${get.poptip("zhiheng")}；群：${get.poptip("wansha")}。②出牌阶段开始时，你可以选择一项：1.弃置X枚“忍”标记并获得一个你未拥有的〖极略〗技能（X为你选择此项的次数+1且至少为2）；2.弃置至多2枚“忍”标记并摸等量张牌。`,
	liuzan: "手杀留赞",
	liuzan_prefix: "手杀",
	...
	xinjyzongshi: "纵适",
	xinjyzongshi_info: "当你拼点后，你观看牌堆顶的一张牌，然后可以选择一项：获得此牌，或获得两张拼点牌中点数较小的一张。",
	dingyuan: "手杀丁原",
	dingyuan_prefix: "手杀",
	beizhu: "备诛",
	beizhu_draw: "备诛",
	...
	xinjianying: "渐营",
	xinjianying_info: "①当你使用与你本阶段使用的上一张牌点数或花色相同的牌时，你可以摸一张牌。②出牌阶段限一次，你可以将一张牌当做任意基本牌使用。若你于此阶段内使用的上一张牌有花色，则此牌的花色视为上一张牌的花色。",
	re_xunyu: "手杀界荀彧",
	re_xunyu_prefix: "手杀界",
	rejieming: "节命",
	...
	mbyijue: "义绝",
	mbyijue_info: "锁定技，当你对一名角色造成到大于等于其体力值的伤害时，其选择交给你任意张牌，然后你选择一项：1.本回合其不能使用或打出牌，且你弃置所有与这些牌花色相同的手牌；2.你防止此伤害，且本轮你与其使用牌指定对方为目标时，取消之。",
	o_meicheng: "缘梅成",
	o_meicheng_prefix: "缘",
	bixian: "壁险",
